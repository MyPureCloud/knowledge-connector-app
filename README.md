...
# Instead of uploading the images to genesys, the original image urls will be kept during sync. The RELATIVE_IMAGE_BASE_URL will be used to modify relative image urls.
